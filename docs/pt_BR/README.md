...
e o site de produção (https://stopcovid19-ishikawa.netlify.com) será então atualizado.
...
| Produção | master | https://stopcovid19-ishikawa.netlify.com | Pull Requests de não administrator são proibidos |

#### Branches usadas pelo sistema
| Propósito | Branch | URL de Confirmação | Detalhes |
| ---- | -------- | ---- | ---- |
| HTML do site de Produção | production | https://stopcovid19-ishikawa.netlify.com | Onde se encontram os HTML estáticos |
