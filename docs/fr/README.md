...
et le site production (https://stopcovid19-ishikawa.netlify.com) est aussi mis-à-jour.
...
Production | master | https://stopcovid19-ishikawa.netlify.com | Pull request d'utilisateurs non-admin sont defendues. |

#### Branches utilisees par le systeme

| But | Branche | URL | Notes |
| ---- | -------- | ---- | ---- |
| Production site HTML | production | https://stopcovid19-ishikawa.netlify.com | Place ou les pages HTML statiques sont stockees. |
